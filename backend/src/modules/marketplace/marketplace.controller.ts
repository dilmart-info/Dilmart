...
/**
 * Public marketplace API — cache-friendly GET.
 */
...
export class MarketplaceController {
  ...
  private resolveViewerContext(
    ...
    const surface: StoreSurface = surfaceParam === "customer_app" ? "customer_app" : "web_store";
  ...
  getBrands(
    ...
    const ctx = this.resolveViewerContext(surface, segment, businessType);
  ...
  async getSuggested(
    ...
    const ctx = this.resolveViewerContext(surface, undefined, undefined);
