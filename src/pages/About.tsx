      ...
      <div className="space-y-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 pt-2">
            <div className="p-4 rounded-xl border border-slate-200/80 bg-slate-50/50 space-y-1.5">
              ...
              <p className="text-xs text-slate-600">
                إمكانية تصفح المتاجر والتعرف على منتجاتها داخل المنصة.
              </p>
            </div>
        ...
        <section className="space-y-4">
          ...
          <ol className="space-y-3 pr-2 list-decimal list-inside text-slate-700 text-sm sm:text-base">
            ...
            <li className="leading-relaxed">
              <strong>الإضافة إلى السلة:</strong> حدد الكمية وأضف المنتج إلى السلة.
            </li>
            <li className="leading-relaxed">
              <strong>تحديد العنوان وإتمام الطلب:</strong> حدد المحافظة والمنطقة ورقم الهاتف، حيث تظهر تكلفة التوصيل وطريقة الدفع المعتمدة للطلب أثناء إتمام الطلب.
            </li>
            <li className="leading-relaxed">
