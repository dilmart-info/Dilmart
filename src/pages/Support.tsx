...
const FAQS: FAQItem[] = [
  ...
  },
  {
    ...
    answer: (
      <div className="space-y-2">
        ...
        <p>
          يتم تقييم أهلية الإرجاع والمهلة المتاحة بناءً على حالة المنتج وسياسات التاجر المعتمدة في النظام.
  ...
  },
  {
    ...
    answer: (
      <div className="space-y-2">
        ...
        <p>
          تعتمد مدة التوصيل على موقع التسليم وتجهيز الشحنة لدى التاجر، وسيتم تزويدك بتحديثات مسار
          الشحنة فور انطلاقها مع مندوب التوصيل.
        </p>
      </div>
    ),
  },
  ...
  },
  {
    ...
    answer: (
      <p>
        نوفر خيار <strong>الدفع عند الاستلام (COD)</strong> للطلبات المؤهلة، بالإضافة إلى أي خيارات دفع
        إلكترونية تظهر للمتسوق أثناء إتمام الطلب بحسب سياسة المتجر والمنطقة.
      </p>
    ),
  },
  {
