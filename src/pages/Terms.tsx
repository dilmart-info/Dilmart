      ...
      <div className="space-y-8">
        ...
        <section className="space-y-3 p-5 rounded-2xl bg-amber-50/60 border border-amber-200/80">
          ...
          <div className="space-y-2 text-xs sm:text-sm text-amber-950/90 leading-relaxed">
            ...
            <p>
              تُعتمد الأسعار والتوفر والخصومات وتكلفة التوصيل التي يتم التحقق منها وعرضها في خطوة
              إتمام الطلب باعتبارها القيم المعتمدة لذلك الطلب. لا يُعد إضافة المنتج إلى السلة حجزاً
              نهائياً للمخزون حتى يتم تأكيد الطلب بنجاح.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-3">
          ...
          <p className="leading-relaxed text-slate-700 text-xs sm:text-sm">
            عند تقديم طلبك، يتلقى النظام الطلب ويُرسل إشعاراً بتأكيد الاستلام. قد يتم التواصل مع المستلم
            عند الحاجة للتحقق من بيانات الطلب أو استكمال متطلبات التوصيل.
          </p>
        </section>
        ...
        <section className="space-y-3">
          ...
          <ul className="space-y-2 list-disc list-inside text-slate-700 text-xs sm:text-sm pr-2">
            <li>
              تُحدد رسوم التوصيل وفق المحافظة والمنطقة المختارة وتظهر واضحة في ملخص الطلب قبل التأكيد.
            </li>
            <li>
              طريقة الدفع الحالية في مسار الطلب هي الدفع عند الاستلام، وتظهر القيمة النهائية المعتمدة للطلب قبل تأكيده.
            </li>
            <li>
              تختلف مدة التوصيل بحسب حالة تجهيز الطلب وموقع التسليم ومسار خدمة التوصيل.
            </li>
          </ul>
        </section>
